                        ...
                        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[600px] text-slate-500 md:text-xl">
                                        Track, manage, and conquer your debt journey with a
                                        supportive community by your side.
                                    </p>
                                </div>
                            ...
                            <div className="relative h-[350px] lg:h-[550px] rounded-xl overflow-hidden">
                                <Image
                                    ...
                                    fill
                                    priority
                                    src="https://assets.grok.com/users/0ba9d868-de51-440b-a901-ea01cc0324b8/xUHGRhTA4zOiagiy-generated_image.jpg"
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2 max-w-[800px]">
                                ...
                                <p className="text-slate-500 md:text-xl">
                                    Our platform provides everything you need to track, manage,
                        ...
                        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Visualize your debt payoff journey with intuitive charts and
                                        metrics
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        Watch your debt decrease over time and celebrate milestones
                                        along the way.
                                    </p>
                                </CardContent>
                            </Card>
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        Share your progress, get advice, and find motivation from
                            ...
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        Stay motivated with badges and achievements as you reach
                            ...
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        Control which debts are visible to the community and which
                                        remain private.
                                    </p>
                                </CardContent>
                            </Card>
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        See your complete payment history and watch your balance
                                        decrease with each update.
                                    </p>
                                </CardContent>
                            </Card>
                            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-slate-500">
                                        From credit cards to student loans, manage all your debts
                        ...
                        <div className="grid gap-8 md:grid-cols-3 mx-auto max-w-5xl">
                            <div className="flex flex-col items-center text-center space-y-3">
                                ...
                                <p className="text-slate-500">
                                    Sign up for free and set up your personal debt dashboard
                                </p>
                            </div>
                            <div className="flex flex-col items-center text-center space-y-3">
                                <div className="bg-primary/10 p-3 rounded-full">
                                ...
                                <p className="text-slate-500">
                                    Enter your current debts and set privacy preferences
                                </p>
                            </div>
                            <div className="flex flex-col items-center text-center space-y-3">
                                <div className="bg-primary/10 p-3 rounded-full">
                                ...
                                <p className="text-slate-500">
                                    Update your progress and engage with the community
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="flex flex-col space-y-4">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500">
                                                    Paid off $32,000 in 18 months
                                                </p>
                                            </div>
                                        </div>
                                        <p className="text-slate-600 italic">
                                            &quot;This platform kept me accountable and motivated.
                                            Seeing my progress visualized made all the difference in
                                            staying on track.&quot;
                                        </p>
                                    </div>
                                </CardContent>
                                    ...
                                    <div className="flex flex-col space-y-4">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500">
                                                    Eliminated $45,000 in student loans
                                                </p>
                                            </div>
                                        </div>
                                        <p className="text-slate-600 italic">
                                            &quot;The community support was incredible. Having others
                                            cheer me on made the journey less lonely and more
                                            achievable.&quot;
                                        </p>
                                    </div>
                                </CardContent>
                                    ...
                                    <div className="flex flex-col space-y-4">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500">
                                                    Debt-free after 3 years
                                                </p>
                                            </div>
                                        </div>
                                        <p className="text-slate-600 italic">
                                            &quot;As a couple, we needed a way to track our combined
                                            debt journey. This platform made it simple to see our
                                            progress together.&quot;
                                        </p>
                                    </div>
                                </CardContent>
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="flex flex-col items-center text-center space-y-4 mx-auto max-w-3xl">
                            ...
                            <p className="text-primary-foreground/80 md:text-xl max-w-[800px]">
                                Join thousands of others who are taking control of their
                                financial future. Start your journey to debt freedom today.
                            </p>
                ...
                <div className="container px-4 md:px-6 mx-auto">
                    ...
                    <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
                        <p className="text-xs text-slate-400">
                            © {new Date().getFullYear()} Till Debt Do Us Part. All rights
                            reserved.
                        </p>
